...
## Initiative: Memory v2 + UCM Foundation (Phase 4.5 abgeschlossen, 2026-04-28)
...
**Naechster Schritt:** Phase 5 (FEATURE-0319) -- Living Document UX: `thread://`-URI-Type, Re-Extraction-Throttle, Auto-Suggestion-Service. Save-to-Memory-Star, `mark_for_memory`/`update_soul`/`inspect_self` und Capability-Snapshot sind bereits in Phase 4 + 4.5 vorgezogen. Phase 4 hat Single-Call live, Drift-Bus verdrahtet, AgingService bereit (Scheduler-Wiring offen) und TokenBudgetGuard im Hot-Path. Combined Note-Index-Pass aus Phase 4 ist als 4.1 deferred -- der vault-side hot-path braucht eigene Spike-Arbeit, bevor er gebuendelt wird.
