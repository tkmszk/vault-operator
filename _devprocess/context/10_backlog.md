...
## Initiative: Memory v2 + UCM Foundation (Phase 4 abgeschlossen, 2026-04-27)
...
**Naechster Schritt:** Phase 5 (FEATURE-0319) -- Living Document UX: `thread://`-URI-Type, Save-to-Memory-Star + Hotkey + `mark_conversation_for_memory`-Tool, Re-Extraction-Throttle, Auto-Suggestion-Service. Phase 4 hat Single-Call live, Drift-Bus verdrahtet, AgingService bereit (Scheduler-Wiring offen) und TokenBudgetGuard im Hot-Path. Combined Note-Index-Pass aus Phase 4 ist als 4.1 deferred -- der vault-side hot-path braucht eigene Spike-Arbeit, bevor er gebuendelt wird.
