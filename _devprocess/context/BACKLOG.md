...
| IMP-24-06-02 | Improvement | 06-02: Tool list_pinned_conversations adden -- gepinnte Chats (Star-Button im HistoryPanel) sind aktuell ueber kein Tool listbar | Backlog | Planned | FEAT-24-06, EPIC-24, FIX-24-06-02 | USER |  |  | 2026-05-13 | P3 Live entdeckt in MESSLAUF Test 2 Teil D Re-Verify: Sebastian fragte nach "Chats als Memory-Source", `list_memory_source_notes` deckt nur Vault-Notizen ab (Mechanismus 1). Gepinnte Chats (Mechanismus 2 via mark_for_memory + FactStore source_conversation_id) haben kein Listing-Tool. Spec in _devprocess/requirements/improvements/IMP-24-06-02-list-pinned-conversations-tool.md. Kein Blocker fuer EPIC-24 Release. |
| IMP-24-04-01 | Improvement | 04-01: research-Profile Completion-Disziplin -- Subagent gibt Meta-Acknowledgement ("X Notizen identifiziert") statt der konkreten vom Parent geforderten Liste; Parent fuehrt Recherche doppelt aus | Backlog | Planned | FEAT-24-04, EPIC-24, ADR-113 | USER |  |  | 2026-05-13 | P2 Live entdeckt in MESSLAUF Test 3 Aktion A: research-Subagent ($0.48) lieferte nur Meta-Antwort, Parent-Agent fuehrte gleiche Recherche nochmal aus ($1.11), Total $1.59 statt erwarteter ~$0.50. Root cause: RESEARCH_PROFILE.roleDefinition betont "short summary" -- Modell interpretiert das als Meta-Bericht statt konkreter Output. Vorschlag: roleDefinition umformulieren ("completion MUST contain the actual answer", Anti-Pattern Beispiel). Spec in IMP-24-04-01-research-profile-completion-discipline.md. Kein Blocker fuer EPIC-24 Release -- FEAT-24-04-Infrastruktur (profile-Spawn, Tool-Allowlist, Parent-Kontext flach) ist live verifiziert. |
