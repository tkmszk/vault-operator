...
| FEAT-29-11 | Feature | Skill-Layout-Konsolidierung + Edit-Folder + Builtin-Materialisierung + Readme-Drop + Export-ZIP | Active | Building | EPIC-29, PLAN-31 | USER |  | sebastian-claude-opus-4-7 | 2026-05-20 | Welle 4. Scope erweitert post-Live-Test-Feedback: (0) data/skills/plugin/ Subfolder entfernen, alle Skills unter data/skills/{name}/ mit source:-Frontmatter-Diskriminator, (A) Edit-Button oeffnet Skill-Folder per electron shell.openPath fuer alle Skill-Typen, (B) Built-ins als materialisierte Folder mit scripts/references/assets-Inventory, (C) Plugin-Readmes konsolidiert in SKILL.md-Body (Option b), (D) Export ganzer Folder als ZIP. PLAN-31. Strikt TDD. |
...
| PLAN-31 | Plan | FEAT-29-11 Skill-Layout-Konsolidierung + Edit-Folder + Builtin + Readme + Export (8 Tasks, TDD-strict) | Active | Building | FEAT-29-11, EPIC-29 | CODE | sebastian-claude-opus-4-7 |  | 2026-05-20 | Welle 4 zweites Feature. Sebastian's Live-Feedback aus FEAT-29-06-Test: alle Skills im selben Folder data/skills/, source-Diskriminator im Frontmatter. Plus Edit-Folder + Builtin-Folder-Layout + Plugin-Readme-Drop + Export-ZIP. |
