...
| FEAT-24-06 | Feature | MCP-Listing-Cap + read_mcp_tool + Built-in deferred-Review | In Progress | Building | EPIC-24, ADR-118, FEATURE-1600 | RESEARCH-36 |  |  | 2026-05-13 | P1 Welle 2. **Scope-Pivot 2026-05-13** im /coding (ADR-117-review.md): ADR-117 supersediert durch ADR-118; Codebase-Befund: MCP-Tools landen NICHT im tools-Feld (registerMcpTool ist TODO-Stub, use_mcp_tool ist Built-in-Bridge, MCP-Listung liegt schon im stabilen Praefix-Block Section 4 vor CACHE_BREAKPOINT). Drei reale Hebel: (1) Description-Cap 200 chars in der MCP-Listung mit read_mcp_tool-Hint im Suffix; (2) neues NICHT-deferred read_mcp_tool(server, name) -- Gruppe `mcp`, volle Description + InputSchema-Summary; (3) zweiter Built-in-deferred-Pass in toolMetadata.ts. PLAN-21 schreibt die drei Tasks. |
