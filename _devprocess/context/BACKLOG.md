...
| Active | 30 | Building | 75 | Feature | 225 |
...
| FIX-01-07-03 | Fix | 07-03: Checkpoint-Restore meldet "Restored", aber Datei behaelt geaenderten Inhalt -- vault.modify-Call laueft durch (Log "restored via vault.modify"), Frontmatter-Aenderung trotzdem sichtbar | Open | Building | FEAT-01-07, EPIC-01 | BUG | | sebastian-claude-opus-4-7 | 2026-05-22 | P1 Live-Repro 2026-05-22 auf NexusOS-Vault, Note `Notes/Backpropagation (Fehlerrückführung).md`. Logs: snapshot(restore-...) liest 28192 chars, restore(commitOid=34dd329d) schreibt 28192 chars, kein Effekt. Hypothesen: (1) falscher Pre-Change-Snapshot-Oid, (2) externes Plugin (templater/dataview/frontmatter-property) ueberschreibt nach vault.modify, (3) Editor-View-Cache. Diagnose blockiert auf Post-Write-Read-back-Logging. Spec: `_devprocess/requirements/fixes/FIX-01-07-03-checkpoint-restore-no-effect.md` |
