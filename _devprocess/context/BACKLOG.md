...
Last update: 2026-05-21 by security-audit (FEAT-29-11 Welle 4 zweites Feature /security-audit-Pass: 2 Low + 2 Info Findings entdeckt, beide actionable im Audit-Pass resolved. Release-Empfehlung: GREEN. Fixes: (L-1) Path-Traversal-Defense in BuiltinSkillMaterializer relPath -- pre-validation (`..`, absolute, NUL-byte) plus post-normalize Containment-Check, fail-soft per File. (L-2) Zip-Slip-Defense in SkillsTab.addFolderToZip -- Containment-Pre-Check pro File und Subfolder. (I-1 Base64-DoS) und (I-2 Build-time-Symlink-Risk) bleiben by-design (Sebastian-managed Bundle, Repo-Trust-Boundary). 4 RED-First-Tests fuer L-1 in BuiltinSkillMaterializer.test.ts. 1904/1925 Tests gruen, 21 baseline unveraendert. Build green 4.4 MB. SCA: 0 production-deps-vulnerabilities. Audit-Report: _devprocess/analysis/AUDIT-FEAT-29-11-2026-05-21.md. FEAT-29-11 ist Release-ready. Naechster Schritt: Test+Audit-Nachholpass fuer FEAT-29-02/03/04 -- Audits liegen bereits unter _devprocess/analysis/AUDIT-FEAT-29-02-2026-05-20.md und _devprocess/analysis/AUDIT-FEAT-29-03-FEAT-29-04-2026-05-20.md, Backlog-Status muss noch nachgezogen werden.)
