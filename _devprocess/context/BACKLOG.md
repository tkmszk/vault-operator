...
Last update: 2026-05-15 by architecture (EPIC-26 ARCH-Pass: 4 neue ADRs (ADR-120 Advisor-Pattern, ADR-121 Tier-Klassifikator, ADR-122 Provider-Schema, ADR-123 Migration) + ADR-115 Amendment + arc42-Sektionen 5.10 und 8.15 + plan-context-epic26.md; Counts via /consistency-check zu verifizieren)
...
| ADR-120 | ADR | Advisor-Pattern als Loop-Default statt Multi-Tier-Routing (consult_flagship-Tool, mid-Tier-Hauptloop, Per-Task-Limit 3, Prompt-Reminder bei mistakes) | Proposed | Building | FEAT-26-01, EPIC-26, ADR-11, ADR-113, ADR-115 | ARCH |  | 2026-05-15 | 2026-05-15 | EPIC-26 Welle 1; Cowork-Pattern adaptiert; Eskalations-Rate-Validation H-03 in Beta; Rollback-Plan ueber defaultMainModelTier-Flip. |
| ADR-121 | ADR | Tier-Klassifikator-Strategie (Pattern-First + Capability-Fallback + OpenRouter-Pricing-Sonderpfad) | Proposed | Building | FEAT-26-02, EPIC-26, ADR-11, ADR-120, ADR-122 | ARCH |  | 2026-05-15 | 2026-05-15 | EPIC-26 Welle 1; zentrale Pattern-Tabelle, Capability-Fallback ueber contextWindow/maxOutputTokens, lokale Provider bleiben manuell; Outlier-Log fuer Pattern-Pflege. |
...
| PLAN-24 | Plan | EPIC-26 Welle 1 -- Advisor-Pattern Engine + Tier-Klassifikator + Discovery (12 Tasks, FEAT-26-01 + FEAT-26-02 Backend) | Draft | Building | FEAT-26-01, FEAT-26-02, EPIC-26, ADR-120, ADR-121, ADR-115 | CODE |  | 2026-05-15 | 2026-05-15 | Critical-Review-Findings F-1 (SubagentProfile.tierOverride), F-2 (Cost-Log mode-Field), F-3 (defaultMainModelTier) als Sub-Tasks aufgenommen; UI/Migration/Chat-Dropdown deferred zu PLAN-25/PLAN-26 (Welle 2). |
