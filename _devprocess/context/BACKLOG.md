...
| FEAT-29-06 | Feature | Sandbox-JS als First-Class-Skill-Pattern | Active | Building | EPIC-29, PLAN-30 | USER |  | sebastian-claude-opus-4-7 | 2026-05-20 | P1 Welle 4. run_skill_script-Tool als generischer Ersatz fuer code_modules / custom_*-Pattern. Strikt TDD (RED-GREEN-REFACTOR) per Memory feedback_tdd_default.md. PLAN-30. Spec: `_devprocess/requirements/features/FEAT-29-06-sandbox-js-first-class.md` |
...
| PLAN-30 | Plan | FEAT-29-06 Sandbox-JS first-class (run_skill_script, code_modules removal, 6 Tasks) | Active | Building | FEAT-29-06, EPIC-29 | CODE | sebastian-claude-opus-4-7 |  | 2026-05-20 | Welle 4 erster Lauf. Strikt TDD (RED-GREEN-REFACTOR). 6 Tasks: A run_skill_script-Tool + Tests, B Bundle-Cache, C code_modules-Removal ManageSkillTool, D CodeModuleCompiler+DynamicToolLoader Deprecation, E builtinModes+ToolRegistry-Wiring, F verify+commit. |
