...
**Feature:** EPIC-018 (Token-Kostenreduktion), Welle 2
...
- ADR-061: Fast Path (orthogonal -- bleibt fuer haeufige Recipe-Patterns)
- ADR-062: KV-Cache-Optimized Prompt (Hebel 8 baut darauf auf)
- ADR-063: Context Externalization (revidiert 2026-04-29, ergaenzt durch Hebel 8)
