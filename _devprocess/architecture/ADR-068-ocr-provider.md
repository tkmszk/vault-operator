...
FEATURE-1905 (OCR-Integration) benoetigt einen OCR-Dienst der gescannte PDFs in strukturiertes Markdown konvertiert. Heute nutzt Obsilo pdfjs-dist fuer PDF-Textextraktion, das bei gescannten oder bildbasierten PDFs scheitert (`No extractable text found`). Die Wahl des OCR-Providers bestimmt Qualitaet, Kosten, Privacy und Plattformkompatibilitaet.

**Triggering ASR:**
- ASR-7 (FEATURE-1905): OCR-Provider-Auswahl -- Quality, Cost, Privacy
...
- ADR-050: SQLite Knowledge DB (Markdown wird nach OCR indexiert)
- ADR-066: Ingest-Strategie (OCR ist Sub-Schritt des Ingest)
- FEATURE-0601: Document Parsing Pipeline (bestehende Parser-Architektur)
