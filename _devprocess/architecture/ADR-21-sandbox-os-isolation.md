...
- `_devprocess/analysis/AUDIT-obsilo-2026-03-01.md` -- Security Audit, Finding H-1
- `_devprocess/analysis/ANALYSE-electron-browserwindow-sandbox-2026-03-02.md` -- Detaillierte Optionen-Analyse
