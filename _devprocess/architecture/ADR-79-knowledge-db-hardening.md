...
3. **Migration-Journal** als Sub-Typ -- existiert nicht, wird neu gebaut (FEAT-03-19 Setup-Wechsel)
4. **PRAGMA integrity_check beim Open** -- explizit ergaenzen zur bestehenden Try-Open-Recovery
5. **Daily-Snapshot-Job** (C2 aus Diskussion) -- existiert nicht, FEAT-03-14 erweitert
...
- **Setup A (Single-Device):** Plugin haelt memory.db + history.db + knowledge.db (knowledge ggf. Vault-resident via FEAT-03-01), Multi-File-Atomic-Commit ueber 2-3 Files je nach knowledge.db-Lokalitaet
