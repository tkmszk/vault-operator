...
related:
  ...
  - PLAN-004-feature-0315-memory-engine-foundation.md
  - _devprocess/requirements/features/FEATURE-0316-memory-migration-vault-rrf.md
---

# PLAN-005 -- Memory v2 Phase 2 Migration + Vault-RRF
...
- **Single-Call-Atomizer mit Tool-Calling (ASR-1):** strukturierter Output
  ...
  ADR-083 (single-call-tool-output-schema) festgelegt -- der Plan nimmt
...
- **FTS/Trigram-Entscheidung:** Spike-2 (Phase 0) hat FTS5-Custom-WASM
  als provisional gruen markiert. PLAN-005 entscheidet definitiv:
...
-- das kommt mit FEATURE-0322 Forget-Right).
...
- Episodes (ADR-018), Recipes (ADR-058), Patterns -- alle bleiben
...
- **memoryModelKey Default:** Aufgabe 6 braucht einen sinnvollen Default.
  FEATURE-0315 hat das als open issue gelassen. Vorschlag: gleicher
...
PLAN-005 erstellt. Status: Active. Trigger: User-Anweisung "backlog
