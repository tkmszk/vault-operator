...
status: Resolved (root cause war anders als initial diagnostiziert)
priority: P2
severity: Medium
...
- Search-Hits ueber den alten Pfad zeigen Reihen, die im Vault nicht mehr
  existieren -- exakt das Problem, das ADR-079 / FEATURE-0314 beheben sollte.
...
- Stale-Search-Hits auf alte Pfade (das Hauptmotiv von ADR-079).
...
PLAN-003 AK 6 (Cascade-Test) bleibt formal gruen via Unit-Tests, aber
