---
id: BUG-029
title: WriterLock-Klasse aus PLAN-003 ist nicht ins Plugin verdrahtet
status: Resolved
priority: P2
severity: Medium
...
plan-refs: [PLAN-003]
related:
  - _devprocess/implementation/plans/PLAN-003-feature-0314-knowledge-db-hardening.md
...
Plugin importiert oder instanziiert. Akzeptanzkriterium 5 in PLAN-003
...
ADR-079 Cloud-Sync-Abwehr" sind dadurch tatsaechlich offen, obwohl im Plan
als gruen markiert.
...
Im PLAN-003 Coverage-Gate steht `SC-05 ✓ WriterLock per PID, Notice bei
...
- Setup-Klasse B (`obsidian-sync`-Storage) ist ohne Schutz gegen
  ...
  der ADR-079 motiviert hat, wird heute nicht abgewehrt.
...
PLAN-003 Coverage-Gate Item "SC-05 / ADR-079 Cloud-Sync-Abwehr" wird auf
