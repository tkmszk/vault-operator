...
status: Green (mit Korrektur des ADR-080-Pfades)
date: 2026-04-26
related:
...
**Konsequenz:** Spike-Pfad gewechselt von ATTACH zu JS-Layer-BFS-Fallback (das war der Plan-B aus ADR-080). Der Fallback ist getestet -- wenn er reicht, ist ATTACH gar nicht zwingend.
...
## Konsequenz fuer ADR-080

**ADR-080 wird modifiziert:**
...
**GREEN** -- ADR-080 Hauptidee bestaetigt (Cross-DB-Queries performant), nur Implementierungspfad geaendert (JS-Layer statt ATTACH).
