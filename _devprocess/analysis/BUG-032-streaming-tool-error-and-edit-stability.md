...
**Status:** Resolved 2026-04-29 (commit 12733c1, alle 4 Provider angepasst)
**Dateien:**
...
**Feature-Bezug:** FEATURE-1804 (Cost-Aware Agent Heuristics, EPIC-018) -- Stabilisierungs-Vorbedingung
...
1. **read_file-Externalization-Sackgasse** -- ADR-063 hat eine Implementation-
...
ADR-063 schrieb urspruenglich *"read_file results NOT externalized"*. Die
...
`ResultExternalizer.ts`). Auch `read_document` (gleiche Semantik). ADR-063 mit
