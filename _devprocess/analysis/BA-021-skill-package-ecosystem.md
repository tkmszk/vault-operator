# BA-021: Skill-Package Ecosystem (Anthropic-kompatibel)
...
|---------|-------|------|----------------|
| Folder-Struktur | 1 SKILL.md pro Ordner | SKILL.md + scripts/ + references/ + assets/ | FEATURE-2201 |
| Zip-Import | nicht moeglich | `.skill` Zip via UI-Button | FEATURE-2202 |
| Scripts | nicht vorhanden | `scripts/` wird via Sandbox-Executor lesbar | FEATURE-2203 |
| Coordinator | ein Skill = eine Rolle | Haupt-Skill + Sub-`.skill.md` im selben Ordner | FEATURE-2204 |
| Anthropic-Frontmatter | ignoriert Anthropic-only Felder | parst `license`/`compatibility`/`metadata` additiv | FEATURE-2201 |
