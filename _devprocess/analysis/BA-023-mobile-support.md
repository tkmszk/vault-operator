...
scope: MVP
created: 2026-04-23
created-by: /business-analyse
epic: EPIC-023 (proposed)
---
...
> **Epic-Zuordnung:** EPIC-023 (neu, noch nicht angelegt)
...
Der `/v-model-workflow`-Orchestrator hat den `Explore`-Subagent mit
...
1. **Morgen:** Sebastian hat im Bett einen Gedanken zu einem
   ...
   sagt: "Neue Idee zu EPIC-019: Lint-Rules fuer veraltete Chunks
...
2. **Agent-Vorarbeit:** Obsilo nimmt den Voice-Input entgegen,
   ...
   Desktop-Index die passende Note "EPIC-019 Knowledge Maintenance"
   und verlinkt sie, setzt Tags `[[Inbox]]` + `[[EPIC-019]]`.
...
- [ ] Handoff zu `/requirements-engineering` (EPIC-023, ca. 10
...
`EXPLORE-023-mobile-support.md` wird angelegt, wenn die Diskussion
