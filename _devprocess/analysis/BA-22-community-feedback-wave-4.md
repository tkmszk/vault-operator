# BA-22: Community Feedback Wave 4
...
(BA-13) and Wave 2: route each bug into its owning Epic, no new Epic,
...
ADR-63 externalises large tool results to `.obsidian-agent/tmp/task-*`
...
`vault_health_check` (FEAT-19-01) and `ingest_document`
(FEAT-19-02 / EPIC-19) ship but were never registered in the
...
- `_devprocess/analysis/BA-22-community-feedback-wave-4.md` (this file)
