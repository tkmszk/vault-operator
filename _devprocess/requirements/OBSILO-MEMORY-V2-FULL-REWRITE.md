...
note: |
  ...
  - PLAN-001-memory-v2-master.md (ueberarbeiteter Implementierungsplan, Pfad alpha)
  ...
  Realitaetspruefungen siehe PLAN-001 Sektion "Doc-Annahmen vs Codebase".
---
...
**Estimated effort (Source-Doc):** 11-13 weeks at part-time pace. Validated in PLAN-001: 11.5 weeks brutto with Phase 0.5 Knowledge-DB-Hardening.
...
> **Hinweis:** Die in der Source-Spec genannten Pfade weichen teilweise von der Codebase-Realitaet ab. Korrekte Pfade siehe PLAN-001.
...
**Duration:** 1 week (in PLAN-001 erweitert auf 1.5 Wochen mit Spikes)
...
### ADR-003: Importance Calibration
...
> **Validierte Schaetzung in PLAN-001: 11.5 Wochen** mit Phase 0.5 Knowledge-DB-Hardening eingeschoben.
...
- Master-Plan (validiert): `_devprocess/implementation/plans/PLAN-001-memory-v2-master.md`
- Existing Memory Architecture: `src/core/memory/`, `src/core/history/`, `src/core/semantic/`
- Anthropic Contextual Retrieval (Obsilo ADR-051)
- ADR-013, ADR-018, ADR-058, ADR-059, ADR-060 (zu superseden bzw. supplementieren)
- BUG-012 (zu fixen in Phase 0.5)

---

> **Wichtig:** Diese Datei ist die *Source-Spec* der Vorab-Konversation. Sie wurde in PLAN-001 gegen die Codebase validiert und ueberarbeitet. Beim Konflikt zwischen dieser Datei und PLAN-001 gilt PLAN-001.
