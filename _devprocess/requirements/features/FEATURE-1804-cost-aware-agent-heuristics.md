...
> **Feature ID**: FEATURE-1804
> **Epic**: EPIC-018 - Token-Kostenreduktion
> **Priority**: P0-Critical
> **Effort Estimate**: M (4-7 Tage)
> **Status**: Implemented (2026-04-29, ADR-090)
> **Related**: ADR-090, ADR-061, ADR-062, ADR-063
...
| SC-07 | System-Prompt unter Welle 1 schrumpft signifikant | -7k Tokens vs vor ADR-090 | Console-Log SystemPrompt-Breakdown |
...
Vollstaendig dokumentiert in **ADR-090: Cost-Aware Agent Heuristics**.
...
Plus zwei **Verification-Brakes** (auch in ADR-090):
...
| Datei | Aenderung |
|-------|-----------|
| `_devprocess/architecture/ADR-090-cost-aware-agent-heuristics.md` | ADR (neu) |
