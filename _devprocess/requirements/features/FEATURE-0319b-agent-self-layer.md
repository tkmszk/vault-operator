...
related:
  - PLAN-001-memory-v2-master.md (Phase 4.5 -- Soul-Gap before Phase 5)
  - ADR-077-storage-schema.md (profile_id partitioning)
  - ADR-085-soft-delete-cascade.md
---

# Feature: Agent-Self Layer (Soul, Capabilities, Self-Awareness)

> **Feature ID:** FEATURE-0319b
...
1. Reservierter `profile_id='_obsilo'` als Konvention dokumentiert in ADR-077 (kein Schema-Change, nur Konventions-Erweiterung).
...
```
| 4.5 Agent-Self Layer | Planned | FEATURE-0319b | Soul + Capabilities + Self-Awareness via profile_id='_obsilo'-Konvention,
