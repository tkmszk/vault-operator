...
- **Impact**: Bestimmt ob Ontologie-Tabelle (FEATURE-1902) vor oder mit Ingest implementiert wird
...
- **Template-gesteuert**: Properties kommen aus User-Templates (FEATURE-1903), nicht aus Settings
- **Bestaetigung**: Trockenlauf oder Batch-Bestaetigung, nie still schreiben

### Open Questions fuer Architekt
- Soll der Skill die Ontologie-Tabelle (FEATURE-1902) direkt befuellen oder einen separaten Schritt triggern?
...
## Dependencies
- **FEATURE-1902 (Ontologie)**: Fuer transitive Entitaets-Zuordnung (kann ohne starten, wird besser mit)
- **FEATURE-1903 (Onboarding)**: Fuer Template-Schema-Erkennung (Fallback: mocPropertyNames aus Settings)
- **FEATURE-1905 (OCR)**: Fuer PDF-Ingest mit gescannten Dokumenten (optional)

## Assumptions
- SemanticIndex und GraphStore sind aktuell (EPIC-015 deployed)
