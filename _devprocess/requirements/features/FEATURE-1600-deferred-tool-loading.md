...
> **Feature ID**: FEATURE-1600
> **Epic**: EPIC-016 (Claude Code Pattern Adoption)
> **Priority**: P1
> **Effort Estimate**: M
> **Status**: Implementiert in Wave 2 (commit pending)
> **Quelle**: EPIC-016 Backlog, Claude Code `ToolSearchTool`-Pattern
...
- Conditional Skills (FEATURE-1602) — separates Feature.
