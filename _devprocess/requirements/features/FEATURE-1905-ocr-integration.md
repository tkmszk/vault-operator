...
```
User triggert Ingest fuer PDF (FEATURE-1900)
...
- [ ] Integration mit Ingest-Skill (FEATURE-1900)
...
## Dependencies
- **FEATURE-1900 (Ingest)**: OCR ist ein Sub-Schritt des Ingest-Workflows
