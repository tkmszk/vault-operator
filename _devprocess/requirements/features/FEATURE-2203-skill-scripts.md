...
`evaluate_expression` Tool (ADR-021). Ausfuehrung passiert NIE automatisch;
...
| SC-03 | Skript-Aufruf triggert immer die Sandbox-Approval (ADR-021) | 100% | Approval-Test |
