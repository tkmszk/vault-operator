...
## Dependencies
- **EPIC-015 (Knowledge Layer)**: GraphStore, ImplicitConnections, KnowledgeDB muessen gebaut sein
- **FEATURE-1902 (Ontologie)**: Fuer den "Schwache Cluster" Check (kann ohne starten)
