...
Zusammenfassung) und Verlinkungen -- unter Nutzung der Ingest-Logik (FEATURE-1900).
...
- **Warum ASR**: Der Synthese-Zettel soll die gleiche Property/Link/MOC-Logik nutzen wie FEATURE-1900
...
- Wie wird der Bezug zur Chat-Nachricht hergestellt (Chat-Link FEATURE-0701)?
...
- [ ] Button verschwindet nicht bei schmaler Sidebar (→ FEATURE-1907)
...
## Dependencies
- **FEATURE-1900 (Ingest)**: Wiederverwendung der Property/Link/MOC-Logik
- **FEATURE-1902 (Ontologie)**: Update nach Zettel-Erstellung
- **FEATURE-0701 (Chat-Linking)**: Optional, fuer Rueckverweis zum Chat
