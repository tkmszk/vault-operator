...
priority: P1
effort: M
depends-on: [FEAT-03-19]
related:
  - PLAN-01-memory-v2-master.md
  - FEAT-04-05-onboarding.md (existierender OnboardingService)
---

# Feature: Memory-UX, Onboarding und Settings-Migration

> **Feature ID:** FEAT-03-23
...
Bestehender OnboardingService (FEAT-04-05) wird erweitert um neuen Schritt 'Memory & UCM':
...
Damit ist Fehler-UX kein UI-Layer (Status-Ampel, Toasts), sondern Conversation-Layer. Konsistent mit FEAT-03-19 Agent-als-Memory-Interface.
...
- **Why ASR:** Konsistenz mit FEAT-04-05
...
- **FEAT-03-19** (Living Document UX): Star-Button + Settings-Schema muessen existieren
- **FEAT-04-05** (OnboardingService): bestehender Service wird erweitert, nicht ersetzt
