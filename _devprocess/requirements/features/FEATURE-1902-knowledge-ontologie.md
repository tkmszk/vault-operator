...
- Wie interagiert die Ontologie mit dem bestehenden Graph Expansion (FEATURE-1502)?
...
- [ ] Inkrementelle Updates bei Ingest (FEATURE-1900)
...
## Dependencies
- **EPIC-015**: KnowledgeDB, GraphStore, ImplicitConnections als Datenquelle
- **FEATURE-1900 (Ingest)**: Befuellt die Ontologie bei jedem Ingest
