# FEAT-04-08: Ollama Provider Management

> **Feature ID**: FEAT-04-08
...
#### F-0408.1: Ollama Health-Status-Indikator
...
#### F-0408.2: Model Pull/Install aus der UI
...
#### F-0408.3: Installed Models mit Details
...
#### F-0408.4: Ollama Server Start/Stop
...
#### F-0408.6: Ollama Library Browse
...
- Kein nativer Ollama-SDK-Provider (bleibt bei OpenAI-compatible, ADR-64 Pattern)
