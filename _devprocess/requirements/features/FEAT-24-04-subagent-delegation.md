...
Profile-System-Prompt + read-only-Tool-Liste; die ADR-90-Tier-4-Justification
...
additiv zu ADR-90). Umsetzung: PLAN-22.
...
4. **Non-profile-Pfad unveraendert:** ohne `profile`-Parameter gelten die
   heutigen ADR-90-Regeln (Tier-4-Justification, 3 Kategorien) weiter.
