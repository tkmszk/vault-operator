...
- Bestehende Dateien werden NICHT automatisch mitumgezogen (ADR-72: intended, aber User-ueberraschend).
...
**Originale werden NICHT geloescht** — User kann sie manuell aufraeumen. Defensive by design (ADR-72-Prinzip).

## Out of Scope

- Absolute-Path-Support fuer KnowledgeDB/MemoryDB (Phase 3 wenn benoetigt).
- Live re-open der DBs ohne Obsidian-Reload.
- Auto-trigger der Migration (User muss explizit klicken, ADR-72-prinzip).
