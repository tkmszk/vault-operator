...
related:
  - PLAN-01-memory-v2-master.md (Phase 5)
  - FEAT-14-11-memory-transparency.md (cross-reference, integriert)
---

# Feature: Living Document UX

> **Feature ID:** FEAT-03-19
...
- [ ] **Crash-Recovery** fuer mid-migration (Migration-Journal aus ADR-79 erweitert)
...
- [ ] FEAT-03-19 Status: Implemented
- [ ] User-Doku: Save-to-Memory-Workflow
- [ ] FEAT-14-11-memory-transparency Cross-Reference (Living Document Indicator)

---

## Dependencies

- **FEAT-03-18** (Single-Call Update Pipeline): Re-Extraction nutzt FactExtractor + FactIntegrator
