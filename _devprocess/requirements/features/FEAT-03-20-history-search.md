...
related:
  - PLAN-01-memory-v2-master.md (Phase 6)
---

# Feature: History Search ueber alle Konversationen

> **Feature ID:** FEAT-03-20
...
- [ ] **Dedizierte `history.db` als Engine-DB** (Multi-File-Atomic-Commit aus ADR-79 traegt drei Files)
...
- **FEAT-03-19** (Living Document UX): ConversationMeta + thread:{id} muessen existieren fuer Filter
- **FEAT-03-14** (Knowledge-DB-Haertung): URI-Konvention + Atomic-Write fuer Schema-Erweiterung
