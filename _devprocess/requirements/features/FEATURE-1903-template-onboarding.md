...
**Aenderung nach Review (ADR-066):** Das Onboarding erstellt keinen Schema-Cache mehr.
...
- [ ] Ingest-Skill (FEATURE-1900) nutzt erkannte Templates korrekt
...
## Dependencies
- **FEATURE-1900 (Ingest)**: Konsument der Templates
