...
priority: P0
effort: M
depends-on: [FEATURE-0315]
related:
  - PLAN-001-memory-v2-master.md (Phase 2)
---

# Feature: Memory-Migration und Vault-RRF-Quick-Win

> **Feature ID:** FEATURE-0316
...
Bestehende Session-Summaries in `memory.db.sessions` (DB-first seit ADR-060) werden **nicht** migriert, sondern bleiben als Sessions-Tabelle nutzbar. Episodes (ADR-018) und Recipes (ADR-058) bleiben unangetastet.
...
- LLM-Atomizer braucht konfigurierten memoryModelKey (haengt am EmbeddingService-Default aus FEATURE-0315)
...
- [ ] FEATURE-0316 Status: Implemented
- [ ] Backlog-Update
...
- **FEATURE-0315** (Engine-Foundation): Stores muessen existieren
- **FEATURE-0314** (Knowledge-DB-Haertung): URI-Konvention und embedding_model-Spalte muessen da sein
