...
> **ADR**: ADR-072
> **Bezogene Features**: FEATURE-0501 (Self-Development), FEATURE-0203 (Skills), FEATURE-0204 (Local Skills)
...
Der konfigurierbare Pfad ist Vault-relativ. Default `.obsidian-agent`. Globale Daten (cross-vault settings, KnowledgeDB im Storage-Mode "global") bleiben unter `{vault-parent}/.obsidian-agent/` falls der storage-mode "global" gewaehlt ist, oder folgen dem konfigurierbaren Pfad falls "local". Details in ADR-072.
