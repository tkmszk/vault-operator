...
- **Aenderungen an SemanticIndex/GraphStore-Logik**: Infrastruktur steht (EPIC-015)

## Dependencies

- **EPIC-015 (Knowledge Layer)**: Vollstaendig implementiert -- SemanticIndex, GraphStore, ImplicitConnections
- **EPIC-003 (Memory)**: MemoryService, KnowledgeDB als Basis fuer Ontologie-Tabelle
- **Bestehende Tools**: read_file, read_document, write_file, semantic_search, list_files
- **Externes**: Chandra OCR API (FEATURE-1905), TaskNotes Plugin (optional, fuer "spaeter"-Flow)
...
## Abgrenzung zu EPIC-015

```
EPIC-015 (done): Vault -> Vektoren + Graph + Implicit Edges    [PASSIV]
EPIC-019 (neu):  Vektoren + Graph + Ontologie ->
