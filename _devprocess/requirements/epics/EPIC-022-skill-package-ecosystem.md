...
> **Epic ID**: EPIC-022
> **Business Alignment**: `_devprocess/analysis/BA-021-skill-package-ecosystem.md`
...
|------------|------|-----|----------|--------|--------|
| FEATURE-2201 | Skill-Folder-Struktur (SKILL.md + Subfolders) | Infra | P0 | M | Geplant |
| FEATURE-2202 | `.skill` Zip-Import | UI + Infra | P0 | S | Geplant |
| FEATURE-2203 | Scripts-im-Skill (Sandbox-Aufruf) | Feature | P1 | M | Geplant |
| FEATURE-2204 | Coordinator-Skill (Multi-Rolle in einem Ordner) | Feature | P1 | M | Geplant |
...
- **ADR-075** (neu): Skill-Package-Architektur — Ordner-Layout, Loader-Umbau, Backward-Compat-Strategie, Security-Modell fuer Scripts.
- **ADR-009** (bestehend, Local Skills): weiter gueltig, EPIC-022 erweitert das Spektrum.
- **ADR-021** (Sandbox): bleibt Security-Wrapper fuer Skill-Scripts.
...
- **FEATURE-0507 Konfigurierbarer Agent-Folder** (released v2.5.x): Skills-Verzeichnis ist jetzt `<agent-folder>/skills/`.
