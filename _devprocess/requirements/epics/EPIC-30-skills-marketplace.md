...
> **Scope**: MVP (Skeleton-Epic, volle Specs folgen nach EPIC-29 Welle 1+2)
> **depends-on**: [EPIC-29]
...
|---|---|---|
| FEAT-30-01 | GitHub-Repo-Struktur und MIT-Lizenz-Policy | Repo-Layout, README, CONTRIBUTING-Doku, MIT-License-Pflicht im SKILL.md-Frontmatter (Anthropic erlaubt `license`-Optional-Feld), CI-Validator fuer License-Check |
| FEAT-30-02 | Skill-Marketplace-Import-UI im Plugin | Neue Settings-Section "Marketplace", Listet Repo-Inhalte, Klick-to-Install, Updates-Check |
| FEAT-30-03 | PR-Workflow und Skill-Validation-CI | GitHub-Actions: SKILL.md-Validation, Sandbox-Smoke-Test, License-Check, optional Test-Coverage-Hinweise |
| FEAT-30-04 | Anthropic-Marketplace-Bridge | Discovery-Link zum Anthropic-Repo, Klick-to-Translate via FEAT-29-08, vorausgewaehlte Top-Skills |
| FEAT-30-05 | Skill-Update-Notifications | Wenn ein installierter Skill im Marketplace eine neue Version hat, klare User-Notification mit Diff-Vorschau |
...
Skeleton-Epic. Die vollen Specs (Feature-Beschreibungen, Success Criteria, Akzeptanzkriterien, NFRs, ASRs) werden in einer eigenen RE-Session erstellt, sobald EPIC-29-Welle 1 plus Welle 2 deployed und stabil sind.
