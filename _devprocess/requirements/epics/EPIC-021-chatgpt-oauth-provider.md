...
> **Epic ID**: EPIC-021
> **Feature Prefix**: FEATURE-021-...
> **Business Alignment**: User-Request 2026-04-28 (analog zu EPIC-012 Copilot, EPIC-013 Kilo Gateway)
> **Scope**: MVP
> **Status**: Geplant
...
|------|-----------|------------------|--------|
| H-01 | Der Codex-PKCE-Flow funktioniert in Electron mit lokalem Loopback-Server (127.0.0.1:1455) zuverlaessig | FEATURE-021-001 | Offen |
| H-02 | Das Token-Schema von `auth.openai.com` (id_token + access_token + refresh_token) bleibt mindestens 6 Monate stabil | FEATURE-021-001 | Offen |
| H-03 | Die Codex-Backend-Endpoints akzeptieren Tool-Calls und Streaming im OpenAI-Responses-API-Format | FEATURE-021-002 | Offen |
| H-04 | ChatGPT-Plus-Subscriber haben Quota-Zugriff auf `gpt-5-codex` und Folgemodelle ueber diesen Endpoint | FEATURE-021-002 | Offen |

## MVP Features

| Feature ID | Name | Prioritaet | Aufwand | Status |
|----------------|---------------------------------------------|------------|--------|---------|
| FEATURE-021-001 | ChatGPT OAuth Lifecycle (PKCE + Loopback + Refresh) | P0 | M | Geplant |
| FEATURE-021-002 | Codex Responses-API Handler | P0 | M | Geplant |
| FEATURE-021-003 | Settings-UI mit "Mit ChatGPT anmelden" | P0 | S | Geplant |
