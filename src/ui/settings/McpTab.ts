...
export class McpTab {
    ...
    private getWorkerPath(): string {
        ...
        const { ensureRuntimeWorker } = require('../../core/utils/runtimeWorker') as typeof import('../../core/utils/runtimeWorker');
        // eslint-disable-next-line @typescript-eslint/no-require-imports -- inlined bundle file generated by esbuild
        const { MCP_WORKER_CODE } = require('../../_generated/bundled-workers') as typeof import('../../_generated/bundled-workers');
        return ensureRuntimeWorker(this.plugin, 'mcp-server-worker.js', MCP_WORKER_CODE);
    }
