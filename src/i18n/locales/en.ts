...
export const en: Translations = {
    ...
    'settings.modes.availableTools': 'Tools',
    'settings.modes.availableToolsHint': 'Functions this agent can call (read files, edit notes, search the web, etc.). Skills are workflow notes the agent loads on demand and are available to every agent.',
    'settings.modes.allowedMcpServers': 'MCP servers',
