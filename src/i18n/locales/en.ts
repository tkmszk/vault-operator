...
export const en: Translations = {
    ...
    'settings.providers.tier.fastDesc': 'Cheapest, lowest-latency model. Used by the helper api (condensing, titling) and the research subagent.',
    'settings.providers.tier.midDesc': 'Default main-loop model in Auto mode. Balance between cost and capability.',
    'settings.providers.tier.flagshipDesc': 'Most capable model. Used by the consult-flagship escalation for one-shot synthesis steps. Empty = advisor pattern disabled.',
