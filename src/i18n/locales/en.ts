...
export const en: Translations = {
    ...
    'ui.suggestionBanner.hiddenNotice': 'Suggestion banner hidden. Re-enable in Settings > Embeddings > Implicit connections.',
    ...
    'onboarding.noModel.setupHint': 'Open the model setup form to pick a provider, paste your API key, and test the connection. Google Gemini has a free tier you can use without a credit card.',
