...
export class ProcessSandboxExecutor implements ISandboxExecutor {
    ...
    private getWorkerPath(): string {
        ...
        const { ensureRuntimeWorker } = require('../utils/runtimeWorker') as typeof import('../utils/runtimeWorker');
        // eslint-disable-next-line @typescript-eslint/no-require-imports -- inlined bundle file generated by esbuild
        const { SANDBOX_WORKER_CODE } = require('../../_generated/bundled-workers') as typeof import('../../_generated/bundled-workers');
        return ensureRuntimeWorker(this.plugin, 'sandbox-worker.js', SANDBOX_WORKER_CODE);
    }
